...
import { useDeactivateProduct } from './useDeactivateProduct';
...
describe('useDeactivateProduct', () => {
  ...
  it('PATCHes the deactivate endpoint for the given id', async () => {
    mockedApiFetch.mockResolvedValueOnce({ id: 'prod-1', isActive: false });
    ...
    expect(mockedApiFetch).toHaveBeenCalledWith('/products/prod-1/deactivate', {
      method: 'PATCH',
    });
  });
