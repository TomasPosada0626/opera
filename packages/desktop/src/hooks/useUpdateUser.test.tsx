...
describe('useUpdateUser', () => {
  ...
  const body = { name: 'Ana Pérez', roleIds: ['role-admin'] };
  const input = { id: 'user-1', ...body };

  it('PATCHes the user by id with the rest of the input as the body', async () => {
    mockedApiFetch.mockResolvedValue({ id: 'user-1', ...body });
