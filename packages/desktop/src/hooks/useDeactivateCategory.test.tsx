...
import { useDeactivateCategory } from './useDeactivateCategory';
...
describe('useDeactivateCategory', () => {
  beforeEach(() => {
    mockedApiFetch.mockReset();
  });

  it('PATCHes the deactivate endpoint for the given id', async () => {
    mockedApiFetch.mockResolvedValueOnce({ id: 'cat-1', isActive: false });
